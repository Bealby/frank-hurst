...
# Function to load 'Book4 - The Peccavi Plot'
@app.route('/book4')
def book4():
    return render_template("book4.html")

# Function to load 'Book5 - The Story Of Jett'
@app.route('/book5')
def book5():
...
# Function to load 'Book7 - The Bangkok Betrayal'
@app.route('/book7')
def book7():
    return render_template("book7.html")

# Function to load 'Book8 - The Shroouded Coast'
@app.route('/book8')
def book8():
